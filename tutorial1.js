class Tutorial1 {
    constructor(){
        ...
        this.dialogue = ["양손에 덤벨을 하나씩 쥐어보세요.", //0
                        "지금부터 화면이 자동으로 넘어갑니다.", //1
                        "별도의 지시가 있기 전까지 덤벨을 놓지 말아주세요.", //2
                        "이제부터 화면에서 안내하는 동작을 따라해볼까요?", //3
                        "먼저 화면처럼 손등이 바깥을 보도록 한 채 팔을 접으세요.\n덤벨이 어깨 높이까지 올라옵니다.", //4
                        "좌측의 바는 덤벨의 실시간 위치를 나타냅니다.", //5
                        "팔꿈치를 고정하고 주황색 선까지 덤벨을 천천히 내려주세요.", //6
                        "아주 좋습니다!\n팔꿈치를 고정하고 팔을 접어 덤벨을 초록색 선까지 올려주세요.", //7
    ...
    display(){
        ...
        switch(this.cut){ // 그림도 있는 경우
            case 4:
                ...
                image(tutorial1_sil[2], width/2, height/2 + 350, 300, 300);
                break;
