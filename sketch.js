...
function preload(){
  ...
  //stage4
  for(let i=0; i<3; i++){
    stage4_bg[i] = loadImage('assets/phase4/stage4/bg/' + i + '.png'); //bg
  }
  // for(let i=0; i<1; i++){
  ...
  for(let i=0; i<9; i++){
    stage4_sil[i] = loadImage('assets/phase4/stage4/sil/' + i + '.png'); // 9
  } //v a:012, b: 345, c:678
  for(let i=0; i<16; i++){
    stage4_ui[i] = loadImage('assets/phase4/stage4/ui/' + i + '.png'); //15
  } //v
