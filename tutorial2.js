class Tutorial2 {
    ...
    display(){
        ...
        switch(this.cut){ // 그림도 있는 경우
            ...
            case 4:
                imageMode(CENTER);
                if (frameCount % 60 < 15) image(tutorial2_sil[0], silX1, silY, silW, silH); // sil
                else if (frameCount % 60 < 30) image(tutorial2_sil[1], silX1, silY, silW, silH);
                else if (frameCount % 60 < 45) image(tutorial2_sil[2], silX1, silY, silW, silH);
                else image(tutorial2_sil[1], silX1, silY, silW, silH);
                if (frameCount % 60 < 15) image(tutorial2_sil[3], silX2, silY, silW, silH); // sil
                else if (frameCount % 60 < 30) image(tutorial2_sil[4], silX2, silY, silW, silH);
                else if (frameCount % 60 < 45) image(tutorial2_sil[5], silX2, silY, silW, silH);
                else image(tutorial2_sil[4], silX2, silY, silW, silH);
                break;
            
            case 5:
                imageMode(CENTER);
                image(tutorial2_sil[0], silX1, silY, silW, silH);
                image(tutorial2_sil[3], silX1, silY, silW, silH);
                break;
